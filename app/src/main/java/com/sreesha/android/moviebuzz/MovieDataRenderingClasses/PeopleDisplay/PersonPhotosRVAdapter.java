 ...
 */
public class PersonPhotosRVAdapter extends RecyclerView.Adapter<PersonPhotosRVAdapter.ViewHolder> {
    ArrayList<PersonImage> posterList;
    Context mContext;
    private static final int POSTER_TYPE = 1;
    private static final int BACKDROP_TYPE = 1;

    public PersonPhotosRVAdapter(ArrayList<PersonImage> posterList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.person_photos_single_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        Log.d("RVDebug", "onBindViewHolder");
