...
/**
 * Created by Sreesha on 04-09-2016.
 */
public abstract class FireBaseRVAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
    ...
    public FireBaseRVAdapter(Query query,Class<T> itemClass){
    ...
    private ChildEventListener mListener=new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            if (!mKeys.contains(key)) {
                T item = dataSnapshot.getValue(FireBaseRVAdapter.this.mItemClass);
        ...
        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
            ...
            if (mKeys.contains(key)) {
                ...
                T newItem = dataSnapshot.getValue(FireBaseRVAdapter.this.mItemClass);
